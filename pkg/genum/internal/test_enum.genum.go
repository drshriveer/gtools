...
// Enum1Value0Complication2 returns the enum's associated trait of the same name.
// If no trait exists for the enumeration a default value will be returned.
func (e MyEnum) Enum1Value0Complication2() MyEnum {
	switch e {
	case Enum1Value0Complication1:
		return Enum1Value0Complication2
	}
